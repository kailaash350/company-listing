...
const indusSearch = "/getCmpByIndustry"
...
function onEnterPress(e) {
  ...
  function searchByIndustry(){
    console.log("search by Industry")
    const myInit = {
        body: {
            industry:industry
        }
    ...
    API.post(myAPI, indusSearch, myInit)
        .then((response) => {
    ...
    return (
        <div className='App' onClick={()=>setshow(false)}>
            ...
            <form onSubmit={deciderFunction}>
                        ...
                        <select id="industry" type='Sector' placeholder='sector' onChange={selectValue}>
                        <option value=''>Select Industry</option>
                            <option value='Basic Material'>Basic Material</option>
                            <option value='Consumer services'>Consumer Service</option>
